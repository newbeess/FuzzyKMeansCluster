...
public class WriteResultToFile {
	 ...
	 */
	public  HashMap<Integer,HashSet<String>> getData(){
		...
		HashMap<Integer, HashSet<String>> item_cluster_weight = new HashMap<Integer, HashSet<String>>();
			...
			double[][] item_GroupLens = rgd.getItemVector(filePath);
			...
			HashMap<Vector,HashSet<String>> index=rcr.vectorToCID_WeightIndez(path);
			ArrayList<Vector> list_Vector_Cluster=rcr.getClusterVector(path);
